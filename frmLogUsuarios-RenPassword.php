<?php
/* * ******************************************************
  Name: frmLogUsuarios-RenPassword.php
  Autor name: �ngel Odil�n Sierra Gonz�lez
  Modification autor name:
  Creation date: 30/01/2015
  Modification date:
  Description: this page is a login form to PWS-Restaurante, this section restart password to user
 * ****************************************************** */
?>
<!DOCTYPE html>
<html lang="en">
                ...
                <div class="stellar-section">
                    <div class="stellar-block stellar13">
                        <div class="container">
                            <div class="row">
                                <div class="grid_12">
                                    <h2 class="hdng__off3"><span>Renovar Contraseña</span></h2>
                                    ...
                                    <form id="frmLogin">
                                        ...
                                        <fieldset>
                                            ...
                                            <div class="row"><div class="grid_4"> </div>
                                                <div class="grid_4">
                                                    <label class="email">Introduce EMail para renovar contraseña
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="btn-wr">
                                                    <a class="btn1" name="btnLogin" id="btnLogin" href="#" data-type="submit">Login</a>  <a class="btn1" name="btnRegister" id="btnRegister" href="#" data-type="submit">Registro</a> 
                                                </div>
